...
public class Adapter_allRight extends RecyclerView.Adapter<Adapter_allRight.MyViewHolder> {
    private Context context;
    private List<Icon> iconList = new ArrayList<>();
    private OnItemClickListener listener;

    public Adapter_allRight(Context context, List<Icon> iconList, OnItemClickListener listener) {
